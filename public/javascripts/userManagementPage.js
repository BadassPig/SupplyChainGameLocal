...
// File is downloaded to browers and dynamically create user management page.
...
function showUserInfo(event) {
    ...
    $('#userInfoRole').text(thisUserObject.userRole);
    $('#userInfoPassword').text(thisUserObject.userPassword);
}
